...
clip.addIncident(
  scale(2, ".dish:nth-child(1) .image", 50, 0, "easeOutSine"),
  startTime
);
clip.addIncident(
  hexagonCircle(800, 450, 50, ".dish:nth-child(1) .background1"),
  startTime
);
...
clip.addIncident(
  leftMove("0%", ".dish:nth-child(1) .description", 500, 0, "easeOutSine"),
  1000 + startTime
);
clip.addIncident(
  rotatedLineReveal(
    "@initParams.dishes[0].brand",
    "@initParams.city",
    ".restaurant"
  ),
  startTime + 1000
...
clip.addIncident(
  svgDraw(1, ".circles-svg path", 2000, "@stagger(0,300)"),
  3000 + startTime
);
clip.addIncident(
  scale(1, ".dish:nth-child(1) .price-wrapper", 800),
  3500 + startTime
);
clip.addIncident(line(".dish:nth-child(1) .price", 200), 5200 + startTime);
clip.addIncident(
  opacity(0, ".dish:nth-child(1) .offer", 200),
  5500 + startTime
);
clip.addIncident(
  opacity(1, ".dish:nth-child(1) .offer", 200),
  5700 + startTime
);
clip.addIncident(
  rotate("8deg", ".dish:nth-child(1) .image", 3500),
  50 + startTime
);
clip.addIncident(
  rotate("0deg", ".dish:nth-child(1) .image", 3500),
  3550 + startTime
);
...
////////////////////////////////////////////////////////////////////////////////
clip.addIncident(
  scale(2, ".dish:nth-child(2) .image", 50, 0, "easeOutSine"),
  startTime2
);
clip.addIncident(
  hexagonCircle(800, 450, 50, ".dish:nth-child(2) .background1"),
  startTime2
);
...
clip.addIncident(
  leftMove("0%", ".dish:nth-child(2) .description", 500, 0, "easeOutSine"),
  1000 + startTime2
);
clip.addIncident(
  rotatedLineReveal(
    "@initParams.dishes[1].brand",
    "@initParams.city",
    ".restaurant"
  ),
  startTime2 + 1000
...
clip.addIncident(
  scale(1, ".dish:nth-child(2) .price-wrapper", 800),
  3500 + startTime2
);
clip.addIncident(line(".dish:nth-child(2) .price", 200), 5200 + startTime2);
clip.addIncident(
  opacity(0, ".dish:nth-child(2) .offer", 200),
  5500 + startTime2
);
clip.addIncident(
  opacity(1, ".dish:nth-child(2) .offer", 200),
  5700 + startTime2
);
clip.addIncident(
  rotate("8deg", ".dish:nth-child(2) .image", 3500),
  50 + startTime2
);
clip.addIncident(
  rotate("0deg", ".dish:nth-child(2) .image", 3500),
  3550 + startTime2
);
...
//////////////////////////////////////////////////////////////////////////////
clip.addIncident(
  scale(2, ".dish:nth-child(3) .image", 50, 0, "easeOutSine"),
  startTime3
);
clip.addIncident(
  hexagonCircle(800, 450, 50, ".dish:nth-child(3) .background1"),
  startTime3
);
...
clip.addIncident(
  leftMove("0%", ".dish:nth-child(3) .description", 500, 0, "easeOutSine"),
  1000 + startTime3
);
clip.addIncident(
  rotatedLineReveal(
    "@initParams.dishes[2].brand",
    "@initParams.city",
    ".restaurant"
  ),
  startTime3 + 1000
...
clip.addIncident(
  scale(1, ".dish:nth-child(3) .price-wrapper", 800),
  3500 + startTime3
);
clip.addIncident(line(".dish:nth-child(3) .price", 200), 5200 + startTime3);
clip.addIncident(
  opacity(0, ".dish:nth-child(3) .offer", 200),
  5500 + startTime3
);
clip.addIncident(
  opacity(1, ".dish:nth-child(3) .offer", 200),
  5700 + startTime3
);
clip.addIncident(
  rotate("8deg", ".dish:nth-child(3) .image", 3500),
  50 + startTime3
);
clip.addIncident(
  rotate("0deg", ".dish:nth-child(3) .image", 3500),
  3550 + startTime3
);
...
clip.addIncident(
  topMove("100%", ".container2", 1),
  7000 + startTime3 + 500 + 500
);
clip.addIncident(scale(0, ".top-circle", 1), 7000 + startTime3 + 1000);
clip.addIncident(opacity(1, ".top-circle", 1), 7000 + startTime3 + 1000);
///////////////////////////////////////////
clip.addIncident(
  topMove("0%", ".plate", 500, "@stagger(0,300)", "easeOutSine"),
  7000 + startTime3 + 500
);
clip.addIncident(
  hexagonCircle(267, 450, 50, ".plate .background"),
  500 + startTime + 500
);
