...
clip.addIncident(textReveal('IBM Plex Sans Arabic, sans-serif',"We have some",".quote1",1500),500);
clip.addIncident(textReveal('IBM Plex Sans Arabic, sans-serif',"deals for you",".quote2",1500),500);
clip.addIncident(textReveal('IBM Plex Sans Arabic, sans-serif',"who love",".quote3a",1500),500);
clip.addIncident(textReveal('IBM Plex Sans Arabic, sans-serif',"@initParams.category",".quote3b",1500),500);
clip.addIncident(textReveal('IBM Plex Sans Arabic, sans-serif',"food, near you!",".quote4",1500),500);
...
clip.addIncident(svgDraw(0,"svg path",1),7000+startTime+490);
...
clip.addIncident(svgDraw(0,"svg path",1),7000+startTime2+490);
...
clip.addIncident(opacity(0,"svg",1),7000+startTime3+490);
